...
截至 2026-05-26，本次核对到的信息：

| 项 | 结果 |
|---|---|
| GitHub 仓库 | `CloakHQ/CloakBrowser` |
| Stars / Forks | 20,834 / 1,648 |
| 最近更新 | 2026-05-25 16:05 UTC |
| 最新 release | `chromium-v146.0.7680.177.5`，2026-05-21 |
| PyPI 最新版本 | `0.3.30`，要求 Python `>=3.9` |
| npm 最新版本 | `0.3.30` |
...
```bash
pip install cloakbrowser==0.3.30
...
```bash
npm install cloakbrowser@0.3.30 playwright-core
```
...
```bash
pip install cloakbrowser==0.3.30
npm install cloakbrowser@0.3.30
docker pull cloakhq/cloakbrowser:0.3.30
```
...
services:
  cloakbrowser:
    image: cloakhq/cloakbrowser:0.3.30
    command: cloakserve
    ports:
      - "127.0.0.1:9222:9222"
