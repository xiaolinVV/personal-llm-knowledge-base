...
- `wiki/notes/openai-agent-mental-model.md`
- 一张 Mermaid 架构图
...
- `wiki/labs/openai/01-responses-api/`
...
- `wiki/labs/openai/02-agents-sdk-basic/`
...
- `wiki/labs/openai/03-tools-and-rag/`
...
- `wiki/labs/openai/04-orchestration-handoffs/`
...
- `wiki/labs/openai/05-guardrails-evals-tracing/`
...
- `wiki/labs/openai/06-sandbox-agents/`
...
- `wiki/topics/ai/anthropic-vs-openai-agent-stack.md`
...
- `wiki/research/use-cases/*.md`
- `wiki/research/open-source-projects/*.md`
- 一个复刻项目
