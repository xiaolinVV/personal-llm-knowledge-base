...
fetched_at: "2026-05-24T03:37:29.386970+00:00"
image_count: 5
---

> Source: [RAGFlow 0.20.0 - Multi-Agent Deep Research](https://ragflow.io/blog/ragflow-0.20.0-multi-agent-deep-research)
>
> 本文件是为本仓库学习实践保存的本地归档版；图片已改写为本地相对路径。

# RAGFlow 0.20.0 - Multi-Agent Deep Research

Aug 7, 2025 · 13 min read

![Figure 1](images/01-multi-agent-cdbe17ff1feaf067d1fbc7b2e611c0fe.png)
...
![Figure 2](images/02-planning-5790c1a10f4140e2bf10dd4bc952b762.PNG)
...
![Figure 3](images/03-1-047be262074651a6edadaf924e7a0b46.PNG)
...
![Figure 4](images/04-2-27f2cbec898c99199f40770bf0c3e9f4.png)
...
![Figure 5](images/05-4-ee0282dfbef105c063f3ff1b6ab39231.png)
