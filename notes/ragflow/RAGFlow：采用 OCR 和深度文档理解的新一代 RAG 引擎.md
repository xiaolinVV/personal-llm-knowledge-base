...
- 后续应进入：`research/open-source-projects/` 可做 RAGFlow 源码/架构拆解；`labs/` 可另开最小实验验证复杂文档解析和 grounded citations。
...
- 是否现在就做：否。本笔记先完成视频归档；实验应单独进入 `labs/`，并用官方 v0.25.2 文档和镜像重新搭建。
