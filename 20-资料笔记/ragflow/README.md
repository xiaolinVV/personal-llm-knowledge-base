...
- [RAGFlow 官方材料 Deep Research](../../40-问题研究/open-source-projects/ragflow/RAGFlow%20官方材料%20Deep%20Research.md)
- [RAGFlow 官方实践案例的工程证据审计](../../40-问题研究/open-source-projects/ragflow/RAGFlow%20官方实践案例的工程证据审计.md)
...
RAGFlow 在本仓库里不是“万能知识库产品”的代名词。它的研究价值主要在文档解析、chunking、hybrid retrieval、rerank、引用溯源、评测和治理。只有当要验证具体工程判断时，才升级到 `50-实验验证/`。
