...
2. 接着做 `50-实验验证/openai/01-responses-api/`，手写一次 function calling 闭环。
3. 再做 `50-实验验证/openai/02-agents-sdk-basic/`，观察 SDK 到底省掉了哪些循环代码。
4. 然后补 `50-实验验证/openai/03-tools-and-rag/`，理解 web/file search 和自定义检索的边界。
