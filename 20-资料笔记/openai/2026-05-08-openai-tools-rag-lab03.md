...
- `50-实验验证/openai/03-tools-and-rag/research_assistant_cli.py`
- `50-实验验证/openai/03-tools-and-rag/data/openai-agent-local-notes.md`
...
```bash
uv run python 50-实验验证/openai/03-tools-and-rag/research_assistant_cli.py \
  "工具边界" \
  --local-search-only
```
