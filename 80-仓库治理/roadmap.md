...
- `20-资料笔记/openai-agent-mental-model.md`
- 一张 Mermaid 架构图
...
- `50-实验验证/openai/01-responses-api/`
...
- `50-实验验证/openai/02-agents-sdk-basic/`
...
- `50-实验验证/openai/03-tools-and-rag/`
...
- `50-实验验证/openai/04-orchestration-handoffs/`
...
- `50-实验验证/openai/05-guardrails-evals-tracing/`
...
- `50-实验验证/openai/06-sandbox-agents/`
...
- `30-稳定知识/ai/anthropic-vs-openai-agent-stack.md`
...
- `40-问题研究/use-cases/*.md`
- `40-问题研究/open-source-projects/*.md`
- 一个复刻项目
