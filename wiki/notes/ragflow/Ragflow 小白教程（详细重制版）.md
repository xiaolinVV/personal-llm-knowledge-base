...
- 后续应进入：如果继续研究，建议进入 `wiki/labs/` 做一个最小部署验证；如果只是跟踪 RAG 产品能力，保留在 `wiki/notes/` 即可。
...
- 最小实验形式：一个 `wiki/labs/ragflow-v0252-local-smoke/`，只保留 README、环境清单、启动命令、一个小样本文档、验证问题、日志定位记录。
